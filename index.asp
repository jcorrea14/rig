        ...
        <div class="container"> 
            ...
            <div class="collapse navbar-collapse bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-left navbar-buttons">
                    ...
                    <li> <a class="page-scroll" href="../data.asp">Login</a> </li>
                </ul>
            </div>
            <!-- /.navbar-collapse --> 
        </div>
...
<header>
    <div class="container">
        <div class="intro-text">
            ...
            <div class="intro-heading">Rig Locator provides current, accurate data on rig activity, and updates the location of all active rigs twice daily.</div>
        </div>
    </div>
</header>
...
<section id="data" class="why-rig-locator">
    ...
    <div class="row">
        <div class="col-lg-7 text-center block-center">
            ...
            <a href="#" class="page-scroll btn btn-xl">View Data</a>
        </div>
    </div>
</section>
...
<section id="map" class="about-rig-locator">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <a href="#" class="page-scroll btn btn-xl">View Map</a>
        </div>
    </div>
</section>
<!-- Who Section -->
