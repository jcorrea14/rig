            ...
            <ul>
              ...
              <li>
                ...
                <p> An electronic drilling rig report provided
                  ...
                  recommended otherwise. (Premium membership required). </p>
              </li>
            </ul>
          </div>
          <div class="col-md-2 pull-right">
            <div class="row">
              <div class="skyscrapper-ad"> <!-- skyscraper -->
            ...
            <asp:Repeater id="result" runat="server">
              <ItemTemplate runat="server">
                <tr style="vertical-align: middle">
                  ...
                  <td> <a href="/report/rig-<%# Eval("S") %>"> <i class="fa fa-print"></i> </a> </td>
                  <td> <a href="/download-file/map-<%# Eval("S") %>.csv"> <i class="fa fa-file-image-o"></i> </a> </td>
                  <td> <a href="/download-file/rig-<%# Eval("S") %>.csv"> <i class="fa fa-file-o"></i> </a> </td>
                </tr>
              </ItemTemplate>
            </asp:Repeater>
          </table>
