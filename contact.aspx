...
<asp:Content runat="server" ContentPlaceholderId="page_meta">
  <meta name="description" content="Contact us at the rig locator with questions about sales, advertising or general rig inquiries." />
</asp:Content>
  ...
  <section id="contact" class="mainContent">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          <p>
            We welcome any feedback, questions or ideas you have
            regarding the Rig Locator. Please complete the form below. You should
            receive a response within two business days.
          </p>
          <p>
            If you would like a response sooner, please feel free to
            contact us at either one of our Edmonton or Calgary office locations.
          </p>
          <div>
            <div class="errormsg">
